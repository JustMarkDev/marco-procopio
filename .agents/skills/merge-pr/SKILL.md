...
Mark a draft ready, then squash merge with branch deletion while preserving the PR title as the squash commit title. Confirm Linear moves from `In Review` to `Merged`, avoiding a duplicate integration transition.
